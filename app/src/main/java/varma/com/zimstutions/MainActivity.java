...
public class MainActivity extends ActionBarActivity implements
   ...
   // private CallbackManager mFacebookCallbackManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et2 = (EditText)findViewById(R.id.et_pass);
        /* *************************************
         *              FACEBOOK               *
         ***************************************/
...
/*
    ...
    public void loginWithPassword() {
        ...
        ad.setPositiveButton("signn up", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ...
                ref.createUser(""+et.getText().toString().trim(), ""+et2.getText().toString().trim(), new Firebase.ValueResultHandler<Map<String, Object>>() {
                    ...
                    public void onSuccess(Map<String, Object> result) {
                        Toast.makeText(MainActivity.this, "successfull created account", Toast.LENGTH_SHORT).show();
    ...
    public void signInWithPassword(View v)
    {
        ...
        ref.authWithPassword(""+username, ""+pass, new Firebase.AuthResultHandler() {
            ...
            @Override
            public void onAuthenticationError(FirebaseError firebaseError) {
                Toast.makeText(MainActivity.this, ""+firebaseError, Toast.LENGTH_SHORT).show();
                // there was an error
            }
        });
    }
